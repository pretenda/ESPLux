...
-- wifiConfig.accessPointConfig.pwd = "ESPLux-"..node.chipid()    -- WiFi password - at least 8 characters

-- wifiConfig.stationPointConfig = {}
-- wifiConfig.stationPointConfig.ssid = "mekanism"    -- Name of the WiFi network you want to join
